...
public class SearchByContent 
{
	...
	public void defaultSearch(String indexdir, String saveInDirectory) throws Exception
	{
		...
		if(fdoc!=null)
        {
	        ...
	        {
	            Document d = searcher.doc(sd.doc);
	            System.out.println("The phrase \'Trump growth' can be found in document "+String.format(d.get("id")));
	            
	            strBuffer.append("The phrase \'Trump growth' can be found in document "+String.format(d.get("id")));
	            strBuffer.append("\n");
	        }
        }
        else
       ...
       {
    	   FileUtils.write(new File(saveInDirectory), report);
       }
	}
	...
	public static void main(String[] args) throws Exception
	{
		...
		System.out.println("Alternatively specify the location of the index" );
			...
			if(ArrayUtils.isNotEmpty(args))
			{
				...
				searchByContent.defaultSearch(indexLocation, "savedReport.txt");
